...
class MiniDateRepository
{
    ...
    private function _getDate()
    {
        ...
        $nationalDay        = [ '09-30', '10-01', '10-02', '10-03', '10-04', '10-05', '10-06' ];
        if (isset($this->request->checkin)) {
            if (in_array(date('m-d', strtotime($this->request->checkin)), $nationalDay)){

                $nationalDayDisable= date("Y-m-d", strtotime("{$this->request->checkin}+1 day"));
                array_push($checkinDisableDate,$nationalDayDisable);
            }
